...
const TextEditor = (props) => {
    ...
    const filesList = props.currentUser.notes.map(note => note.name);


    const deleteButtons = ["delete char", "delete word", "delete all"];

    //פתיחת פתק מה-select
    const openFileFromList = (e) => {
    ...
    //החלפת סטייל מכאן והלאה
    const handleDesignFromHere = () => {
        props.saveToHistory();
    ...
    return (
        <>
            ...
            <div className="keyboard-toolbar">
                ...
                <button className="save-as-button" onClick={handleSaveAs}>save as...</button>
                ...
                <button onClick={handleDesignAllText}>Style all text</button>

                <button onClick={handleDesignFromHere}>Style from here</button>
                ...
                <button className="space-button" onClick={handleSpace}>Space</button>
